...
/* $Id: util.cpp 132 2009-07-10 18:19:11Z sausage $
...
namespace util
{
	...
	{
	std::transform(subject.begin(), subject.end(), subject.begin(), static_cast<int(*)(int)>(TOLOWER()));
	//TOLOWER(subject);
	}
...
#undef max
	...
	void sleep(double seconds)
	{
		...
		timespec ts = { static_cast<__darwin_time_t>(sec), static_cast<long>(nsec) };
		nanosleep(&ts, 0);
#endif // defined(WIN32) || defined(WIN64)
	}
